        ...
        setTimeout(() => {
            ...
            if (mesasSolicitadas <= mesasDisponibles) {
                if (mesasSolicitadas === 1) {
                    resolve(`${mesasSolicitadas} mesa disponible.`);
                } else {
                    resolve(`${mesasSolicitadas} mesas disponibles.`);
                }
            } else {
    ...
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            if (exito) {
                ...
                reject(`Error al enviar correo de confirmación a ${nombreCliente}`);
            }
...
async function hacerReserva(nombreCliente, mesasSolicitadas) {
    try {
        ...
        console.log(confirmacion);  // Muestra el resultado del envío de correo
